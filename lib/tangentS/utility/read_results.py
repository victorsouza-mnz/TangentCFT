...
from lib.tangentS.utility.comp_query import CompQuery
        ...
        for idx, line in enumerate(lines):
            ...
            if len(parts[0]) == 0:
                ...
                if current_name is None or current_expr is None:
                    ...
                    expression = parts[3]
                    score = float(parts[4])
                    current_expr.add_result(
                        doc_id, doc_name, location, expression, score
                    )
            ...
            if len(parts[0]) == 0:
                ...
                if parts[0][0] == "Q":
                    ...
                    try:
                        ...
                        print(
                            "No math_tan results found for query name " + current_name
                        )
                        current_query = CompQuery(current_name)
                        all_queries[current_name] = current_query
